 ...
 */
export declare type YogaNodeServerOptions<TServerContext, TUserContext, TRootValue> = Omit<YogaServerOptions<TServerContext, TUserContext, TRootValue>, 'multipart'> & {
    /**
     * Port to run server
     */
    port?: number;
