...
const loadTs = _interopDefault(require('cosmiconfig-typescript-loader'));
...
var LoadersRegistry = /** @class */ (function () {
    ...
    LoadersRegistry.prototype.loadTypeDefs = function (pointer, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, load.loadTypedefs(pointer, __assign({ loaders: Array.from(this._loaders), cwd: this.cwd }, options))];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, load.loadTypedefs(pointer, __assign({ filterKinds: load.OPERATION_KINDS }, loadSchemaOptions))];
                    case 1:
    ...
    LoadersRegistry.prototype.loadSchemaSync = function (pointer, out, options) {
        ...
        var schemaDoc = this.transformSchemaSources(load.loadTypedefsSync(pointer, __assign({ filterKinds: load.OPERATION_KINDS }, loadSchemaOptions)));
